            ...
            <div className="flex flex-col items-center gap-4">
              {!googleClientId ? (
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 w-full h-14 bg-white rounded-xl border border-gray-200 text-gray-700 font-semibold text-base shadow-sm hover:bg-gray-50 active:scale-[0.98] active:bg-gray-100 transition-all cursor-pointer select-none"
                >
